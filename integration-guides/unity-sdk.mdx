...
<Steps>
  ...
  <Step title="Install SDK Files" titleSize="h3">
    ...
    <AccordionGroup>
      <Accordion title={<span>Option A - Using the Unity Plugin <Badge color="green" size="sm">Recommended</Badge></span>}>
      ...
      <Accordion title="Option B - Manual">
        ...
        <img
          ...
          alt="Drag AAR file into Android folder"
          width="400"
        />
      </Accordion>
    </AccordionGroup>
  ...
  <Step title="Add Main Gradle and Gradle Properties Files" titleSize="h3">
    ...
    <img
      src="/integration-guides/image/unity_integration_guide_2.png"
        ...
        <AccordionGroup>
          ...
          <Accordion title="Unity Editor Customization Example">
            ...
            <img
              ...
              alt="Unity Custom Consent In-Game"
              width="600"
            />
            ...
            **Step 1 - Define variables in your initializer script**
            ...
            <img
              ...
              alt="Texture Import Settings Read/Write"
              width="400"
            />
