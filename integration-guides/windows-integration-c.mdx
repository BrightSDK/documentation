...
2. **<u>Add SDK Initialization to Your Code:</u>** <u>Steps:</u>
   ...
   2. Set required fields (use `brd_config.json` and/or set them programmatically - see [<u>API Documentation</u>](https://docs.bright-sdk.com/integration-guides/windows-integration-c#api-documentation)).
   3. Call `brd_sdk_init()`.
