...
<Steps>
  ...
  <Step title="Install SDK Files" titleSize="h3">
    ...
    - [**Using the Bright SDK integration CLI tool**](https://github.com/BrightSDK/bright-sdk-integration) <Badge color="green">Recommended</Badge> - automatically downloads the SDK, copies the required files, and patches your `.csproj` with the necessary references.
    ...
    <AccordionGroup>
      <Accordion title="Option A - Using the Integration Tool (Recommended)">
        Run the tool using the [bright-sdk-integration](https://github.com/BrightSDK/bright-sdk-integration) CLI. See the [Windows example](https://github.com/BrightSDK/bright-sdk-integration/blob/main/example/windows/README.md) for full setup instructions.
