...
Integrating [EarnApp](https://earnapp.com/) is the first step toward earning revenue. Once you've released your app bundle you can start earning per install!
...
- **Bright Data products do not do any user tracking of any kind**. You can read more about EarnApp and privacy in its [FAQ](https://help.earnapp.com/hc/en-us?_gl=1*1hf5rjl*_gcl_au*MTc3ODI5OTY1MS4xNzU2MjA4MDkxMVFDkGAB2a1RoLEAAYASACEgJnWfD_BwE).
...
<Steps>
  ...
  <Step title="Set Up Your Offer Screen" titleSize="h3">
    ...
    **Optional:** You may design the opt-in any way you choose (we recommend the design to be as close as possible to your installation wizard). However, the [EarnApp offer screen](https://drive.google.com/file/d/1rgXzXvkiVLRQ2it3mSZLX8R6vwCYXUq_/view) must always include an opt-in consent screen with the mandatory text below.
    ...
    1. **Mandatory Text** Optional offer by <a href="https://earnapp.com/"><img src="/integration-guides/image/earnapp_integration_3.png" alt="EarnApp" noZoom style={{height: "1em", width: "auto", display: "inline"}} /></a>
  ...
  <Step title="Assets" titleSize="h3">
    - Drive folder: [Link](https://drive.google.com/drive/folders/1qPW40HZITGKO71udwxKz1XxbW0RbwL5S).
  </Step>
  ...
  <Step title="Technical Integration" titleSize="h3">
    1. **Dynamically download** the bundler using the link present in your bundle page in the [Bright SDK control panel.](https://bright-sdk.com/cp/bundles)
       <img
         ...
         width="400"
       />
       **Download URL format:** [_https://cdn.bright-sdk.com/static/BrightSDK-Bundler.exe?filename=earnapp-bundle-\[your\_bundle\_code\].exe_](https://cdn.bright-sdk.com/static/BrightSDK-Bundler.exe?filename=earnapp-bundle-[your_bundle_code].exe)
