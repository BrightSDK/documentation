...
Optional offer by [earnapp](https://earnapp.com)
...
1. **Dynamically download** the bundler using the link present in your bundle page in the Bright SDK control panel. Download URL format:
   ```text
