...
<Steps>
  ...
  <Step title="Technical Integration" titleSize="h3">
    1. **Dynamically download** the bundler using the link present in your bundle page in the [<u>Bright SDK control panel.</u>](https://bright-sdk.com/cp/bundles)
       ...
       />
       **Download URL format:**
       [_https://cdn.bright-sdk.com/static/BrightSDK-Bundler.exe?filename=earnapp-bundle-\[your\_bundle\_code\].exe_](https://cdn.bright-sdk.com/static/BrightSDK-Bundler.exe?filename=earnapp-bundle-[your_bundle_code].exe)
