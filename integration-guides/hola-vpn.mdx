...
Optional offer by [hola](https://holavpn.com/)
...
1. Dynamically download - the app using the link present in your bundle page in the Bright SDK control panel. <u>Downloaded filename format:</u> `Hola-Setup-csa-aid-[AFFILIATE_CODE].exe.` <u>Example:</u> `Hola-Setup-csa-aid-a58kz.exe.`
   <Warning>
