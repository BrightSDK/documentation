...
<Steps>
  ...
  <Step title="Choose Your Offer Type" titleSize="h3">
    1. **Scenario 1 – Installation Wizard Offer:** Offer your users the benefits of Hola VPN by adding a screen to your install wizard.
    ...
    2. **Scenario 2 – Uninstall Webpage Offer:** Earn revenue from users who choose to uninstall your product by presenting a Hola VPN install offer on your product's uninstall page.
       <img
       ...
       - A short message alongside an offer banner is shown. Get your dedicated custom link under "**Bundle Details**" on your dashboard app page and implement it onto CTA. Contact [<u>support@hola.org</u>](mailto:support@hola.org) for further assistance.
       ...
       **<u>Implementation instructions:</u>**
       ...
       - In "**Bundle Details**", confirm Offer Type shows "**Uninstall Page Offer**" → copy download URL to implement onto your CTA.
         <img
           ...
           width="400"
         />
    3. **Scenario 3 – Successful Install Page:** Earn revenue from users who successfully installed your product by presenting a Hola VPN install offer on your product's successful installation page.
       ...
       **<u>Implementation instructions:</u>**
       ...
       - In "**Bundle Details**", confirm Offer Type shows "**Successful Installation Page Offer**" → copy download URL to implement onto your CTA.
         <img
           ...
           width="400"
         />
    4. **Scenario 4 – Ad Campaign:** Create an ad campaign offering to install Hola VPN - get paid for every install you bring!
       ...
       **<u>Implementation instructions:</u>**
       ...
       - In "**Bundle Details**", confirm Offer Type shows "**AdCampaign**" → copy download URL to implement onto your campaign.
         <img
           ...
           width="400"
         />
    5. **Scenario 5 – In-App Offer:** Present a Hola VPN install (banner/popup, etc.) within your app.
       ...
       **<u>Implementation instructions:</u>**
       - Go to [**<u>Monetized Bundles</u>**](https://bright-sdk.com/cp/bundles) → **Add Bundle** → Choose "**In-App Offer**" → Press "**Create**".
       - In "**Bundle Details**", confirm Offer Type shows "**In-App Offer**" → copy download URL to implement onto your offer.
         <img
           ...
           width="400"
         />
    6. **Scenario 6 – Preinstalled App:** Install Hola VPN on products you distribute (refurbished products, device manufacturers, OEM, etc.).
  ...
  <Step title="Set Up Your Offer Screen" titleSize="h3">
    ...
    **Optional:** You may design the opt-in any way you choose (we recommend the design to be as close as possible to your installation wizard). However, the Hola VPN offer screen must always include an opt-in consent screen with the mandatory text below.
    ...
    - In the [**<u>Assets</u>**](#assets) section you may find all the imagery needed.
