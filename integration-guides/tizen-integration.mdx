...
<Steps>
  ...
  <Step title="Extract SDK Framework">
    ...
    - **SDK Integration Components:**
      - <u>service directory -</u> The main engine containing all logic required to run the SDK. Must be copied next to your other services.
      - <u>brd_api.js -</u> Frontend interface implementing the consent screen. Must be integrated with your application's frontend.
  </Step>
