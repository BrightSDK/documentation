  ...
  <Step title="Install SDK Files" titleSize="h3">
    ...
    <AccordionGroup>
      <Accordion title={<span>Option A - Using the Integration Tool <Badge color="green" size="md">Recommended</Badge></span>}>
        Run the tool using the [bright-sdk-integration](https://github.com/BrightSDK/bright-sdk-integration) CLI. See the [Tizen example](https://github.com/BrightSDK/bright-sdk-integration/blob/main/example/tizen/README.md) for full setup instructions. The tool will:
