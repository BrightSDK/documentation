  ...
  <Step title="Install SDK Files" titleSize="h3">
    ...
    <AccordionGroup>
      <Accordion title="Option A - Using the Integration Tool (Recommended)">
        Run the tool using the [bright-sdk-integration](https://brightsdk.github.io/bright-sdk-integration/) CLI. See the [webOS example](https://github.com/BrightSDK/bright-sdk-integration-example-webos) for full setup instructions.
