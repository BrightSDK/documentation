...
<Steps>
  ...
  <Step title="Install SDK Files" titleSize="h3">
    ...
    - [**Using the Bright SDK integration CLI tool (Recommended)**](https://github.com/BrightSDK/bright-sdk-integration) - automatically downloads the SDK, copies the required files into your app directory, and injects the script tags into `index.html`.
