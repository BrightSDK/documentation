...
<Note>
  For Unity-specific integration help, refer to the [Unity Android SDK Integration Guide](https://docs.bright-sdk.com/integration-guides/unity-sdk).<br />Adding Bright SDK to most apps takes 15 to 20 minutes.
</Note>
    ...
    <AccordionGroup>
      ...
      <Accordion title="Option 2 - CustomConsentSettings">
        ...
        <img
          ...
          alt="Default Bright SDK consent screen"
          width="400"
        />
