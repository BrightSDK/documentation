...
<Steps>
  ...
  <Step title="Extract SDK AAR" titleSize="h3">
    Download the latest Bright SDK from the [Bright SDK Dashboard](https://bright-sdk.com/cp/docs/sdk/android) or from the link provided in the latest release email. Unzip the archive.
  ...
  <Step title="Integrate Bright SDK" titleSize="h3">
    ...
    **Option 2 - Manual process name detection:**
    ...
    <Note>
      See [this article](https://stackoverflow.com/questions/19631894/is-there-a-way-to-get-current-process-name-in-android) for reference on detecting process names in Android.
    </Note>
