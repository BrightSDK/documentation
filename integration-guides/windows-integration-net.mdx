...
See [Code Example](https://docs.bright-sdk.com/integration-guides/windows-integration-net#code-example) and use `cs_winform_anycpu` and `cs_wpf_anycpu` from samples directory for reference.
...
**<u>Command Line Tool (net\_updater32.exe):</u>**
