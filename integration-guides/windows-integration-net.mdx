  ...
  <Step title="Install SDK Files" titleSize="h3">
    ...
    <AccordionGroup>
      <Accordion title="Option A - Using the Integration Tool (Recommended)">
        Run the tool using the [bright-sdk-integration](https://brightsdk.github.io/bright-sdk-integration/) CLI. See the [Windows example](https://github.com/BrightSDK/bright-sdk-integration-example-windows/blob/main/README.md) for full setup instructions.
