...
3. Use `brd_config.json` and/or set them programmatically (see [<u>API Documentation</u>](https://docs.bright-sdk.com/integration-guides/windows-integration-net#api-documentation)).
