...
<Steps>
  ...
  <Step title="Install SDK Files" titleSize="h3">
    ...
    - [**Using the Bright SDK Integration CLI Tool**](https://github.com/BrightSDK/bright-sdk-integration) <Badge color="green">Recommended</Badge> - automatically downloads the SDK, extracts the framework, and patches your Xcode project with the necessary references.
    ...
    <AccordionGroup>
      <Accordion title={<span>Option A - Using the Integration CLI Tool <Badge color="green" size="sm">Recommended</Badge></span>}>
        Run the tool using the [`bright-sdk-integration`](https://github.com/BrightSDK/bright-sdk-integration) CLI. See the [Apple example](https://github.com/BrightSDK/bright-sdk-integration/tree/main/example/apple) for full setup instructions.
      ...
      <Accordion title="Option B - Manual">
        Download the latest Bright SDK using the [Bright SDK downloader](https://bright-sdk.com/cp/docs/sdk/ios). Unzip it.
