...
| --- | --- |
| Native iOS (Swift) | [Step 3.1](#step-3-1) → [Step 3.2](#step-3-2) |
| Native iOS (Objective-C) | [Step 3.1](#step-3-1) → [Step 3.3](#step-3-3) |
| tvOS | [Step 3.1](#step-3-1) → [Step 3.4](#step-3-4) |
| Unity (Unity Editor level) | [Step 3.5](#step-3-5) |
| Unity (Xcode level) | [Step 3.1](#step-3-1) → [Step 3.6](#step-3-6) |
...
1. Embed the framework - follow [<u>Step 3.1</u>](https://docs.google.com/document/d/14TcuduJU-AzxYBWyttBmSVb_M0rELo8-4dKY2YMue0M/edit?tab=t.0#heading=h.3fumz9ya2f0k)<u>.</u>
...
Use this path if you want to integrate Bright SDK entirely at the Unity level without modifying Xcode. If you prefer to integrate at the Xcode level instead, skip to [<u>Step 3.6</u>](https://docs.google.com/document/d/14TcuduJU-AzxYBWyttBmSVb_M0rELo8-4dKY2YMue0M/edit?tab=t.0#heading=h.e3426ot8bw8h). Do not follow both - choose one.
...
1. Open `BrightDataSDK/BrdsdkBridge.cs` and review the available SDK API calls ( [<u>API (Unity Plugin)</u>](https://docs.google.com/document/d/1y-qTCojMd4Bp0yVtXyffwELaKgi2tJ1aouD1C6qTHiQ/edit?tab=t.0#heading=h.m1zyw37jj2sk))
...
4. Implement the Settings screen following [<u>Step 4: Add Opt-In/Out Settings Option</u>](https://docs.google.com/document/d/14TcuduJU-AzxYBWyttBmSVb_M0rELo8-4dKY2YMue0M/edit?tab=t.0#heading=h.aaeyd22qcd48), using `BrightDataSDK/Sample/SettingsBehaviour.cs` as a reference.
...
Use this path if you want to integrate Bright SDK at the Xcode level for a Unity project. If you already completed [<u>Step 3.5</u>](https://docs.google.com/document/d/14TcuduJU-AzxYBWyttBmSVb_M0rELo8-4dKY2YMue0M/edit?tab=t.0#heading=h.jophwo33zu71), skip this section.
...
<Warning>
  _If you have other 3rd-party frameworks that need to initialize before your game launches, consider using [<u>Step 3.5 (Unity Editor integration)</u>](https://docs.google.com/document/d/14TcuduJU-AzxYBWyttBmSVb_M0rELo8-4dKY2YMue0M/edit?tab=t.0#heading=h.jophwo33zu71) instead._
</Warning>

#### 3.6.1 Embed the Bright SDK Framework

1. Follow [<u>Step 3.1</u>](https://docs.google.com/document/d/14TcuduJU-AzxYBWyttBmSVb_M0rELo8-4dKY2YMue0M/edit?tab=t.0#heading=h.3fumz9ya2f0k) for the main app target.
