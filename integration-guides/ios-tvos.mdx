...
<Steps>
  ...
  <Step title="Integrate Bright SDK" titleSize="h3">
    ...
    | :-- | :-- |
    | Native iOS (Swift) | Step 3.1 → Step 3.2 |
    | Native iOS (Objective-C) | Step 3.1 → Step 3.3 |
    | tvOS | Step 3.1 → Step 3.4 |
    | Unity (Unity Editor level) | Step 3.5 |
    | Unity (Xcode level) | Step 3.1 → Step 3.6 |
    ...
    <Steps>
      <Step title="3.1 Embedding the Framework in Xcode">
        ...
        4. Select your app target under the **Targets** list
           ...
           <img src="/integration-guides/image/tvOS_Integrate_Bright_SDK_1.png" alt="Xcode Project Navigator" width="600" />
        ...
        8. Confirm that it shows **Embed & Sign** next to `brdsdk.xcframework`
           ...
           <img src="/integration-guides/image/tvOS_Integrate_Bright_SDK_2.png" alt="Embed and Sign" width="600" />
      </Step>
      ...
      <Step title="3.5 Integration in Unity Editor">
        ...
        _Use this path if you want to integrate Bright SDK entirely at the Unity level without modifying Xcode. If you prefer to integrate at the Xcode level instead, skip to Step 3.6. Do not follow both - choose one._
      ...
      <Step title="3.6 Integration in Xcode (Unity)">
        ...
        **3.6.1 Embed the Bright SDK Framework**
        ...
        2. Additionally, link `brdsdk.xcframework` with `UnityFramework`:
           ...
           <img src="/integration-guides/image/tvOS_Integrate_Bright_SDK_3.png" alt="Build Phases Link Binary" width="600" />

        **3.6.2 Embed the SDK Dialog in Your Code**

        <img src="/integration-guides/image/tvOS_Integrate_Bright_SDK_4.png" alt="Consent UI Mockup" width="300" />
        ...
        4. Embed the `Data` folder into `UnityFramework.framework`:
           ...
           <img src="/integration-guides/image/tvOS_Integrate_Bright_SDK_5.png" alt="Target Membership Checkbox" width="400" />
      </Step>
    </Steps>
  </Step>
