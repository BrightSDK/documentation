...
<Steps>
  ...
  <Step title="Integrate Bright SDK" titleSize="h3">
    ...
    | --- | --- |
    | Native iOS (Swift) | [Embedding the Framework in Xcode](#embedding-the-framework-in-xcode) → [Integration in Xcode (iOS – Swift)](#integration-in-xcode-ios-–-swift) |
    | Native iOS (Objective-C) | [Embedding the Framework in Xcode](#embedding-the-framework-in-xcode) → [Integration in Xcode (iOS – Objective-C)](#integration-in-xcode-ios-–-objective-c) |
    | tvOS | [Embedding the Framework in Xcode](#embedding-the-framework-in-xcode) → [Integration in Xcode (tvOS)](#integration-in-xcode-tvos) |
    | Unity (Unity Editor level) | [Integration in Unity Editor](#integration-in-unity-editor) |
    | Unity (Xcode level) | [Embedding the Framework in Xcode](#embedding-the-framework-in-xcode) → [Integration in Xcode (Unity)](#integration-in-xcode-unity) |

    <Steps>
      <Step>
        #### Embedding the Framework in Xcode
      ...
      <Step>
        #### Integration in Xcode (iOS – Swift)
      ...
      <Step>
        #### Integration in Xcode (iOS – Objective-C)
      ...
      <Step>
        ...
        **Reference sample:** `sample_tvos_xcode`.
        ...
        1. Embed the framework - follow the [**Embedding the Framework in Xcode**](#embedding-the-framework-in-xcode) steps above.
      ...
      <Step>
        ...
        **Reference sample:** `unity_sample_app_2020.2.5`, `unity_admob_sample_app`.
        ...
        Use this path if you want to integrate Bright SDK entirely at the Unity level without modifying Xcode. If you prefer to integrate at the Xcode level instead, skip to [**Integration in Xcode (Unity)**](#integration-in-xcode-unity). Do not follow both - choose one.
      ...
      <Step>
        ...
        **Reference sample:** `unity_xcode_sample_app`
        ...
        <Warning>
          _If you have other 3rd-party frameworks that need to initialize before your game launches, consider using the Unity Editor integration instead._
        </Warning>
  ...
  <Step title="Flows of Showing the Consent Screen" titleSize="h3">
    ...
    **Flow 1 - SDK's built-in consent screen** The SDK checks authorization internally. No additional setup required.
    ...
    **Flow 2 - Custom consent screen**
    ...
    <Tip>
      See [**Custom Consent Screen (optional)**](#custom-consent-screen-optional) for design and full integration requirements.
    </Tip>
  </Step>
