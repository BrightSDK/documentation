  ...
  <Step title="Integrate Bright SDK" titleSize="h3">
    ...
    <Steps>
      <Step>
        ...
        <Note>
          **CLI Tool users:** The framework is already extracted and referenced in your `.xcodeproj` - confirm Embed & Sign is set and skip to [Integration in Xcode (iOS – Swift)](#integration-in-xcode-ios-–-swift).
        </Note>
