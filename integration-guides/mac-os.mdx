...
import CustomConsent from "/snippets/custom-consent-screen-macos.mdx";
    ...
    <Steps>
      <Step title="Project Setup">
        ...
        **Add the Framework and Service to Your Target**
        ...
        <img
          src="/images/guides/macos_integrate_bright_SDK_1.png"
          alt="Alt text"
          width="400"
        />
        ...
        <img
          src="/images/guides/macos_integrate_bright_SDK_2.png"
          alt="Alt text"
          width="400"
        />
        ...
        **Configure net\_updater Copy Location**
        ...
        <img
          src="/images/guides/macos_integrate_bright_SDK_3.png"
          alt="Alt text"
          width="400"
        />
        ...
        3. Add a new **Copy Files** build phase:
           ...
           - Add `net_updater` to this phase.
             <img
               src="/images/guides/macos_integrate_bright_SDK_4.png"
               alt="Alt text"
               width="400"
             />
        ...
        **Add Re-sign Build Phase**
        ...
        <img
          src="/images/guides/macos_integrate_bright_SDK_5.png"
          alt="Alt text"
          width="400"
        />
