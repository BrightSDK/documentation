    ...
    <AccordionGroup>
      ...
      <Accordion title="Option B - Manual">
        ...
        **SDK Overview**
        ...
        <Warning>
          Before using `brdsdk.framework` and `net_updater.app`, additional Xcode project configuration steps are required — see [Project Setup](https://docs.google.com/document/d/1Topce82TpDiun3AipmIa570je7RFgDat5zRhzcReetI/edit?tab=t.0#heading=h.8xufmydodl2e).
        </Warning>
      </Accordion>
    </AccordionGroup>
  </Step>
