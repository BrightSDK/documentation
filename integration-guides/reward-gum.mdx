...
<Steps>
  <Step title="Important Notes" titleSize="h3">
    ...
    - **Bright Data products do not do any user tracking of any kind**. You can read more about RewardGUM and privacy in its FAQ.
  ...
  <Step title="Choose Your Offer Type" titleSize="h3">
    ...
    1. **Scenario 1 – Installation Wizard Offer:** Offer your users the benefits of RewardGUM by adding a screen to your install wizard.
  ...
  <Step title="Set Up Your Offer Screen" titleSize="h3">
    ...
    **Optional:** You may design the opt-in any way you choose (we recommend the design to be as close as possible to your installation wizard). However, the RewardGUM offer screen must always include an opt-in consent screen with the mandatory text below.
    ...
    - You may implement the RewardGUM offer screen onto your wizard (make sure to include all the links provided below).
    ...
    - In the **Assets** section you may find all the imagery needed.
      <img
        src="/integration-guides/image/rgum_integration_1.png"
        alt="Alt text"
        width="400"
      />

    1. **Mandatory Text** Optional offer by <a href="https://rewardgum.com/"><img src="/integration-guides/image/rgum_integration_2.png" alt="RewardGUM" noZoom style={{height: "1em", width: "auto", display: "inline"}} /></a>
       _When you click "Accept", you agree to install "RewardGUM" and consent to its Privacy Policy and EULA._
  ...
  <Step title="Technical Integration" titleSize="h3">
    ...
    **<u>Validation Checklist:</u>** Before submitting for review, complete the following checklist:
    ...
    - Privacy Policy and EULA links are visible and clickable:
      - EULA: [<u>https://rewardgum.com/user-agreement</u>](https://rewardgum.com/user-agreement)
      - Privacy Policy: [<u>https://rewardgum.com/privacy</u>](https://rewardgum.com/privacy)
