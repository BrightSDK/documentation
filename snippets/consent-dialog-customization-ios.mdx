...
<Info>
  All customization parameters are available for Xcode-level integration. A subset is available for Unity Editor-level integration via [<u>BrdsdkBridge.cs</u>](http://brdsdkbridge.cs).
</Info>
...
<img
     src="/integration-guides/image/iOS_Consent_Dialog_Customization_1.png"
     alt="Alt text"
     width="400"
   />
...
### 5.2 Action Button Images (Opt-In / Opt-Out)
...
**Objective-C:** Use the `ColorSettings` class — see <u>API Documentation</u> for full property list.
...
<Danger>
  <u>Warning:</u> The SDK has limitations for font sizes.
</Danger>
...
**Objective-C:** Use the `ConsentFontsInfo` class — see <u>API Documentation</u> for full constructor and method list.