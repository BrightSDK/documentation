  ...
  <>
    ...
    <ol>
      <li>
        ...
        <ul>
          ...
          {(platform === "webos" || platform === "tizen") && (
            <>
              <li><strong>WebOS:</strong> <a href="https://docs.bright-sdk.com/integration-guides/webos-integration#integrate-bright-sdk-in-your-code">see</a>.</li>
              <li><strong>Tizen:</strong> <a href="https://docs.bright-sdk.com/integration-guides/tizen-integration#integrate-bright-sdk-in-your-code">see</a>.</li>
            </>
          )}
        </ul>
      </li>
      <li>
        ...
        <p>
          Important: if your app is a <a href="https://webostv.developer.lge.com/develop/getting-started/web-app-types">Hosted Web App</a> maintain SDK file version consistency across all components.
        </p>
        <p>
