...
3. **Integration Code**
   1. **Skip Default Consent Screen**
      Pass `skip_consent: true` in the SDK's initialization method to prevent showing the default consent screen.
   2. **Track Consent Screen Display**
      When your external consent screen is displayed, call `brd_api.consent_shown()`, this ensures statistics are correctly recorded.
