  ...
  <Accordion title="Custom Consent Screen">
    ...
    1. **Design Requirements**
       ...
       1. **Mandatory Text**
          ...
          ```
       2. **QR Code**
          Include a QR code linking to: [https://bright-sdk.com/users#learn-more-about-bright-sdk-web-indexing](https://bright-sdk.com/users#learn-more-about-bright-sdk-web-indexing). You can use your own branded QR code or hosted version, as long as it directs to this URL.
