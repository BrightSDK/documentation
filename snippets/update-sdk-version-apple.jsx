  ...
  <>
    <AccordionGroup>
      ...
      <Accordion title="Option B - Manual">
        ...
        <img src="/integration-guides/image/snippets/update_SDK_iOS_1.png" alt="Alt text" width="400" />
        ...
        {platform === "ios" && (
          <>
            ...
            <img src="/integration-guides/image/snippets/update_SDK_iOS_2.png" alt="Alt text" width="400" />
