...
<Steps>
  <Step title="Methods">
    ...
    | `brd_api.external_opt_in()` | `callbacks` | Call this after the user agrees on your own custom consent screen. [See Custom Consent Screen (optional)](#) for more details. |
  ...
  <Step title="Settings Object">
    ...
    **`agree_btn` (string/enum)**
    Sets the **agree** button text. Default: `I_AGREE`
    ...
    <Tip>You can also pass any custom string - if it doesn't match an enum value, it will be displayed as-is.</Tip>

    **`disagree_btn` (string/enum)**
    Sets the **disagree** button text. Default: `Keep Ads`
