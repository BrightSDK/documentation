    ...
    <AccordionGroup>
      ...
      <Accordion title="Enums & Classes (Swift / Obj-C)">
        ...
        **Class: `ColorSettings`**
        ...
        | `qr_foreground_color` | `UIColor?` | QR code foreground color _(tvOS only)_ |
        | `qr_background_color` | `UIColor?` | QR code background color _(tvOS only)_ |
        ...
        **Instance Methods** _(all return `Self` for chaining; all warn on invalid font; all subject to SDK size limits):_
