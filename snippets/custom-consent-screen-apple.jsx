      ...
      <Accordion title="Option 1 - Custom Consent Screen">
        ...
        {platform === "ios" && (
          <>
            ...
            <img
              src="/integration-guides/image/snippets/iOS_Custom_Consent_Screen_1.png"
        ...
        {platform === "macos" && (
          <>
            <p>This is what it looks like on the default Bright SDK screen:</p>
            <img
              src="/integration-guides/image/snippets/iOS_Custom_Consent_Screen_2.png"
...
Read Bright Data's [Privacy Policy] and [End User License Agreement].`}</code></pre>
        ...
        <Columns cols={2}>
          <Column>
            <img
              src="/integration-guides/image/snippets/iOS_Custom_Consent_Screen_4.png"
          ...
          <Column>
            <img
              src="/integration-guides/image/snippets/iOS_Custom_Consent_Screen_5.png"
