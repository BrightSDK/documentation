...
<Columns cols={2}>
  <Card img="/images/snippets/opt-in-out-windows-1.png">
  </Card>

  <Card img="/images/snippets/opt-in-out-windows-2.png">
  </Card>

  <Card img="/images/snippets/opt-in-out-windows-3.png">
  </Card>

  <Card img="/images/snippets/opt-in-out-windows-4.png">
  </Card>
</Columns>
