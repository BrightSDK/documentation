...
<Columns cols={2}>
  <img
    src="/integration-guides/image/snippets/add-opt-in-out-unity-1.png"
    alt="Alt text"
    width="400"
  />

  <img
    src="/integration-guides/image/snippets/add-opt-in-out-unity-2.png"
    alt="Alt text"
    width="400"
  />
</Columns>
...
<img
  src="/integration-guides/image/snippets/add-opt-in-out-unity-3.png"
  alt="Alt text"
  width="400"
/>
...
<Columns cols={2}>
  <img
    src="/integration-guides/image/snippets/add-opt-in-out-unity-4.png"
    alt="Alt text"
    width="400"
  />

  <img
    src="/integration-guides/image/snippets/add-opt-in-out-unity-5.png"
    alt="Alt text"
    width="400"
  />
</Columns>
