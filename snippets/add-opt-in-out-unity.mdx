...
<Columns cols={2}>
  <img src="/snippets/image/add-opt-in-out-unity-1.png" alt="Alt text" width="400" />
  <img src="/snippets/image/add-opt-in-out-unity-2.png" alt="Alt text" width="400" />
</Columns>
...
<Columns cols={2}>
  <img src="/snippets/image/add-opt-in-out-unity-4.png" alt="Alt text" width="400" />
  <img src="/snippets/image/add-opt-in-out-unity-5.png" alt="Alt text" width="400" />
</Columns>
