...
1. **Adding Opt-In/Out to Your Existing Settings Menu**
   **Requirements:**
   ...
   2. <u>Add value text below the switch -</u> Emphasize the benefits users get when opting in. ([see examples](https://docs.bright-sdk.com/integration-guides/tizen-integration#:~:text=Value%20Text%20Examples%3A))
   3. Include a way to give more information
      - Best practice: Include a QR code linking to: [<u>https://brightdata.com/sdk/information?is\_tv=1</u>](https://brightdata.com/sdk/information?is_tv=1)
...
2. **If You Don't Have a Settings Menu**
...
3. **Consent Dialog Customization (Optional)**
