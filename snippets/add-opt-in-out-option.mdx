...
1. **Add a switch labeled "Web Indexing"**
...
#### If You Don't Have a Settings Menu
...
3. **Custom Button Text:** You can customize button text on the consent screen by passing an object to `simple_opt_out`.
   Example:
   ```javascript
   {
