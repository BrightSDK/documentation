...
- In our dashboard, update your billing contact and payment details under **"[Company Profile](https://bright-sdk.com/cp/settings/company_profile?partner=uzj_qben_zhx1lqs&reviews_tab=active#:~:text=Billing%20%2D%20payment%20details)"**. [Learn more about our billing process](https://docs.bright-sdk.com/help-center/payment-information#what-is-the-process-to-get-the-monthly-payment).
