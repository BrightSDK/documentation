...
<Note>
  You must run uninstall with **admin privileges** or the user will see a UAC prompt asking for elevation. **Admin privileges** are required for successful uninstallation.
</Note>
