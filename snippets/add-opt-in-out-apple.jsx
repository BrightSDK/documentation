...
@IBAction func bright_sdk_checkbox_action(_ sender: NSButton) {
    ...
    <Columns cols={2}>
      <Card img="/_mintlify/image/brightdatasdk/images/snippets/opt-in-out-iphone-1.png" style={{ width: "33%", borderRadius: "8px" }}></Card>
      <Card img="/_mintlify/image/brightdatasdk/images/snippets/opt-in-out-iphone-2.png" style={{ width: "33%", borderRadius: "8px" }}></Card>
      <Card img="/_mintlify/image/brightdatasdk/images/snippets/opt-in-out-iphone-3.png" style={{ width: "33%", borderRadius: "8px" }}></Card>
      <Card img="/_mintlify/image/brightdatasdk/images/snippets/opt-in-out-iphone-4.png" style={{ width: "33%", borderRadius: "8px" }}></Card>
    </Columns>
    ...
    <Columns cols={2}>
      <Card img="/_mintlify/image/brightdatasdk/images/snippets/opt-in-out-iphone-5.png" style={{ width: "33%", borderRadius: "8px" }}></Card>
      <Card img="/_mintlify/image/brightdatasdk/images/snippets/opt-in-out-iphone-6.png" style={{ width: "33%", borderRadius: "8px" }}></Card>
    </Columns>
  </>
);
