...
<AccordionGroup>
  <Accordion title="Custom Consent Screen">
    ...
    2. **QR Code**
       ...
       <br />
       <img
         src="/images/guides/custom_consent_screen1.png"
         alt="Alt text"
         width="400"
       />
       <img
         src="/images/guides/custom_consent_screen2.png"
         alt="Alt text"
         width="400"
       />
    3. **Localization**
  ...
  <Accordion title="Customize the Default Consent Dialog (optional)">
    ...
    <img
      src="/images/guides/consent_screen_customization.png"
      alt="Alt text"
      width="400"
    />
    ...
    <img
      src="/images/guides/consent_screen_default.png"
      alt="Alt text"
      width="400"
    />
